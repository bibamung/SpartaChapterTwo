    ...
    public class Item
    {
        ...
        public void addTestItems()
        {
            ItemsDictionary = new Dictionary<int, Item>
            {
                ...
                { 1001, new Item(1001, "강철 검", 1, 5, "무기", 1500, "강한 검이다.", false) },
                { 1002, new Item(1002, "마법 지팡이", 3, 12, "하의", 2000, "마법을 증폭시키는 지팡이.", false) },
                { 1003, new Item(1003, "가죽 방어구", 0, 10, "장신구", 800, "가죽으로 만든 방어구.", false) }
            };
        }
        ...
        public void shopScene(Player player, Inventory inventory, bool isfail = false)
        {
            while (true)
            {
                ...
                {
                    case 1:
                        buyItemDisplay(player, inventory);
                        break;
                    case 2:
        ...
        // 아이템 구매 로직
        public void buyItemDisplay(Player player, Inventory inventory, bool isfail = false)
        {
            while (true)
            {
                Console.Clear();
                ...
                if (input >= 1 && input <= ItemsDictionary.Values.ToList().Count) selectedItem = ItemsDictionary.Values.ToList()[input - 1];
