...
namespace Sylphyr
{
    public class Inventory
    {
        ...
        // 인벤토리 메뉴
        public void invenDisplay(Player player, bool isfail)  
        {
            Console.Clear();
        ...
        public void EquipDisplay(Player player, bool isfail = false)   
        {
            ...
            var selectedItem = invenitems[input - 1];  // 번호에 맞는 아이템을 선택
            ...
            switch (input)
            {
                ...
                default:
                    if (!selectedItem.isEquip)
                    {
                        ...
                        {
                            case 0:
                                player.criticalDamage += selectedItem.Stat2;
                                break;
                            case 1:
                                player.dex += selectedItem.Stat2;
                                break;
                            case 2:
                                player.luk += selectedItem.Stat2;
                                break;
                            case 3:
                                player.def += selectedItem.Stat2;
                                break;
                        }
                    }
                    else
